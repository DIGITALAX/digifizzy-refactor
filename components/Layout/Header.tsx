...
//         <div className="relative grid-flow-row auto-rows-[auto auto] md:w-fit h-full min-h-full font-amR text-xs grid md:place-self-start place-self-center text-center md:text-left md:pr-20 lg:pr-11 gap-6">
